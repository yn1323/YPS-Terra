...
let RequestService = class RequestService {
    async addRequest(args) {
        const result = await common_2.collections.request
            .add(args)
    ...
    async getRequest(args) {
        let ret = [];
        const snapshot = await common_2.collections.request
...
], RequestService.prototype, "addRequest", null);
__decorate([
    __param(0, (0, graphql_1.Args)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [args_1.GetRequestArgs]),
    __metadata("design:returntype", Promise)
], RequestService.prototype, "getRequest", null);
